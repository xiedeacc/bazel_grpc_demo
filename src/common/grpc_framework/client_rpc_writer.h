...
#ifndef GRPC_FRAMEWORK_RPC_CLIENT_WRITER_H
#define GRPC_FRAMEWORK_RPC_CLIENT_WRITER_H
...
public:
  ...
  int Write(const RequestType &request) {
    ...
    if (status_ == DONE) {
      LOG(ERROR) << "cannot write for write has done!";
      return -1;
    }
...
#endif // GRPC_FRAMEWORK_RPC_CLIENT_WRITER_H
