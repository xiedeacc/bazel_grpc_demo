...
#ifndef GRPC_FRAMEWORK_MESSAGE_QUEUE_H
#define GRPC_FRAMEWORK_MESSAGE_QUEUE_H
...
template <typename MSG> class MsgQueue {
public:
  MsgQueue(size_t buffer_size = 1024 * 1024 * 64)
    ...
    work_thrd_ = std::thread(&MsgQueue::work_thrd_func, this);
  };
...
protected:
  ...
  virtual void merge_msg(const std::list<MSG *> &src, std::list<MSG *> &dest,
                         Arena *arena){};
...
#endif // GRPC_FRAMEWORK_MESSAGE_QUEUE_H
