...
class RouteGuideImpl final
    : public grpc_demo::common::proto::RouteGuide::CallbackService {
public:
  ...
  ListFeatures(CallbackServerContext *context,
               const grpc_demo::common::proto::Rectangle *rectangle) override {
    class Lister : public grpc::ServerWriteReactor<Feature> {
    public:
      Lister(const grpc_demo::common::proto::Rectangle *rectangle,
             const std::vector<Feature> *feature_list)
  ...
  grpc::ServerReadReactor<Point> *RecordRoute(CallbackServerContext *context,
    ...
    public:
      Recorder(RouteSummary *summary, const std::vector<Feature> *feature_list)
          : start_time_(system_clock::now()), summary_(summary),
  ...
  RouteChat(CallbackServerContext *context) override {
